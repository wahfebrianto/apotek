...
<div class="row">
    <div class="col-sm-12 text-center">
        ...
        <h4 class="text-navy"><b>LAPORAN LABA RUGI BERSIH</b></h4>
...
<div class="table-responsive m-t">
    <table class="table invoice-table">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="5" class="text-right">
                  Modal dari seluruh obat yang keluar pada bulan ini :
                </td>
                <td class="text-right">
                  <span class="pull-left">Rp.</span>-{{number_format(floatval($hasil['modal']),2,',','.')}}
                </td>
            </tr>
            <tr>
                <td colspan="5" class="text-right">
...
<table class="table invoice-total">
    <tbody>
        <tr>
            ...
            <td>{{number_format((floatval($hasil['penjualan']) - floatval($hasil['modal']) - floatval($hasil['gaji']) - floatval($hasil['pengeluaran'])),2,',','.')}}</td>
        </tr>
    </tbody>
</table>
@endsection
