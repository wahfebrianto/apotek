...
(function($) {
    ...
    $.widget("ui.combobox", {
        ...
        _create: function() {
            ...
            input.addClass("form-control ui-combobox-content ui-widget ui-corner-left cm-10");
            ...
            var btn = $("<button><span class='glyphicon glyphicon-collapse-down'></span></button>");
            btn.attr("tabIndex", -1);
            ...
            btn.addClass("ui-corner-right ui-button-icon cm-2");
            btn.click(function() {
